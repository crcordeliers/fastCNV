...
HDBreast <- CNVCluster(HDBreast)
HDBreast <- mergeCNVClusters(HDBreast, mergeThreshold = 0.95)
...
tree_data <- CNVTree(HDBreast, values ="calls", cnv_thresh = 0.09, healthyClusters = c("5","6"))
