...
``` {r cnv_classification, fig.width=7, fig.height=4}
...
SpatialDimPlot(STColon1, group.by = "11p_CNV_classification") +
  ...
  common_theme | SpatialDimPlot(STColon1, group.by = "13q_CNV_classification") +
  scale_fill_manual(values = c(gain = "red", no_alteration = "grey", loss = "blue")) +
  common_theme
...
We can see there are 2 tumor subclusters (1 and 2) in STColon1, and 3 healthy subclusters (0, 3 and 4). 
...
cnv_matrix_clusters <- generateCNVClonesMatrix(STColon1, healthyClusters = c("0", "3", "4"))
