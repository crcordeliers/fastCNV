...
FeaturePlot(scColon1, features = "cnv_fraction", reduction = "umap", ) |
  DimPlot(scColon1, reduction = "umap", group.by =  "annot")
```
...
```{r plot_cnv_per_chromosome, fig.width=7, fig.height=3.5}
library(scales)
...
``` {r cnv classification, fig.width=7, fig.height=3.2}
...
DimPlot(scColon1, group.by = "cnv_clusters")
```
