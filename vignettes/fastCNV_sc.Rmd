...
As we can see, there are 5 tumor subclusters (0, 2, 3, 4 and 6) in scColon1, and 2 healthy subclusters (1 and 5). 
...
cnv_matrix_clusters <- generateCNVClonesMatrix(scColon1, healthyClusters = c("1", "5"))
