...
scColon1 <- CNVcluster(scColon1, resolution = 0.4, nPCs = 25)
```
...
As we can see, there are 3 tumor subclusters (0, 1 and 4) in scColon1, and 2 healthy subclusters (2 and 3), with clone 5 being the juxtatumoral cells. 
...
cnv_matrix_clusters <- generateCNVClonesMatrix(scColon1, healthyClusters = c("2", "3"))
